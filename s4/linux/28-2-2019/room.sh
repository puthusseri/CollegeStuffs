...
for ((i=0; i<40; i=$((i+8))))
do
	printf "${class2[$i]} ${class2[$((i+1))]}		"
	printf "${class2[$((i+2))]} ${class2[$((i+3))]}		"
	printf "${class2[$((i+4))]} ${class2[$((i+5))]}		"
	printf "${class2[$((i+6))]} ${class2[$((i+7))]}\n"
done>class2.txt

#Write to output	class 3
for ((i=0; i<40; i=$((i+2))))			#Sem 1 
do
	class3[i]=${s1[j]}
	j=$((j+1))
...
for ((i=0; i<40; i=$((i+8))))
do
	printf "${class3[$i]} ${class3[$((i+1))]}		"
	printf "${class3[$((i+2))]} ${class3[$((i+3))]}		"
	printf "${class3[$((i+4))]} ${class3[$((i+5))]}		"
	printf "${class3[$((i+6))]} ${class3[$((i+7))]}\n"
done>class3.txt